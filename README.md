...
2. **Kocor = siklus.** Jalankan nomor 1 → 2 → 3, lalu ulangi dari nomor 1, sampai ciri fase berikutnya muncul.
...
| Fase | Siklus (jalankan lalu ulangi) | Volume kocor |
|---|---|---|
...
> **Cara pakai:** jalankan nomor 1 → 2 → 3, lalu **ulangi dari nomor 1**. Keluar dari siklus hanya bila ciri fase berikutnya muncul ([Bagian 3](#3--peta-ciri--aksi-inti-dokumen)).
...
| # | Ember | Bahan per 200 polybag |
|---|---|---|
| 1 | 🟡 Humate | PH (Potassium Humate) **40 g** |
| 2 | 🟢 NPK-1 | YaraMila **40 g** + PH **40 g** + Vitaflex **5 g**\* |
| 3 | 🔵 Kalsium | CN-G **32 g** |
...
| # | Ember | Bahan per 200 polybag |
|---|---|---|
| 1 | 🟢 NPK-2 | YaraMila **90 g** + PH **50 g** + MgSO4 **50 g** |
| 2 | 🔵 Kalsium | CN-G **40 g** |

\* Vitaflex **6,25 g** ditambahkan ke ember 🟢 pada **siklus V2 pertama saja**.
...
|---|---|---|
| 🟢 **Ember 1 (NPK)** | air → YaraMila → Vitaflex (bila ada) → MgSO4 (bila ada) → KNO3 (khusus V3) → **PH** | ⚠️ PH dilarutkan **terpisah** di 1-2 L air, baru dituang sambil diaduk |
...
| Meroke Vitaflex | 5\* | 6,25\* | — | — | — | — |

\* Hanya di **siklus pertama** V1 dan V2.
...
\* Target pro-rata: rekomendasi fertigasi cabai musim penuh **230 N - 90 P2O5 - 400 K2O kg/ha** (±9,2 / 3,6 / 16 g per tanaman pada 25.000 populasi). Plan ini mencakup s.d. panen pertama ≈ **40% musim** → target 3,7 / 1,4 / 6,4 g.
